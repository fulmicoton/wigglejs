...
(function() {
  ...
  var handleFileSelect, parseCompound;

  parseCompound = function(data) {
    var extendedXmp, result, xmp;
  ...
  handleFileSelect = function(evt) {
    ...
    cb = function() {
      ...
      imageReader.onload = function(e) {
        ...
        return load_animation(compound.imageUri, compound.depthUri, canvas, function(animation) {
          return animation.play(canvas, 50);
        });
      };
      return imageReader.readAsBinaryString(file);
    };
